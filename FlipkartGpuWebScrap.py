...
for i in range(1,8):
    ...
    for link in TopDiv:
        ...
        if isinstance(anchor1,type(None))==False and isinstance(anchor2,type(None))==False and isinstance(anchor3,type(None))==False:
            ...
            print(f'Launch Price: {launchprice}')
            print(f'Product Rating: {productrating}')
            print(f'Percentage Off: {offpercentage}')
            print(f'Delivery Charges: {deliverycharges}')
            # print(f'Time vs Price: {pricevstime}')
            print(f'Product Link: {productlink}')
            print(f'Image Link: {imglink}')
            print('')